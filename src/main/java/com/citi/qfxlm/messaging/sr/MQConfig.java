  ...
  org.springframework.jms.connection.CachingConnectionFactory; import
  ...
  import com.ibm.mq.jms.MQQueueConnectionFactory; import
  ...
  @EnableJms public class MQConfig {
  
  @Value("${ibm.mq.hostName}") private String host;
  
  @Value("${ibm.mq.portName}") private Integer port;
  
  @Value("${ibm.mq.queueManager}") private String queueManager;
  
  @Value("${ibm.mq.channel}") private String channel;
  
  @Value("${ibm.mq.user}") private String username;
  ...
  MQQueueConnectionFactory(); mqQueueConnectionFactory.setHostName(host); try {
  mqQueueConnectionFactory.setTransportType(WMQConstants.WMQ_CM_CLIENT);
  mqQueueConnectionFactory.setCCSID(1208);
  mqQueueConnectionFactory.setChannel(channel);
  mqQueueConnectionFactory.setPort(port);
  mqQueueConnectionFactory.setQueueManager(queueManager); } catch (Exception e)
  { e.printStackTrace(); } return mqQueueConnectionFactory; }

	/*
	 * // @Bean // UserCredentialsConnectionFactoryAdapter
	 * userCredentialsConnectionFactoryAdapter(MQQueueConnectionFactory
	 * mqQueueConnectionFactory) { // UserCredentialsConnectionFactoryAdapter
	 ...
	 * mqQueueConnectionFactory); // return userCredentialsConnectionFactoryAdapter;
	 * // }
	 */  
  @Bean
  
  @Primary public CachingConnectionFactory cachingConnectionFactory() {
  ...
  cachingConnectionFactory.setReconnectOnException(true); return
  cachingConnectionFactory; }
  
  @Bean public PlatformTransactionManager jmsIBMMQTransactionManager() {
  JmsTransactionManager jmsTransactionManager = new JmsTransactionManager();
  jmsTransactionManager.setConnectionFactory(cachingConnectionFactory());
  return jmsTransactionManager; }
  
  @Bean public JmsTemplate mqJMSOperations() { JmsTemplate jmsTemplate = new
  JmsTemplate(cachingConnectionFactory()); return jmsTemplate; }
  
	/*
	 * // @Bean // public DefaultJmsListenerContainerFactory
	 * jmsListenerContainerFactory(CachingConnectionFactory
	 * cachingConnectionFactory) { // DefaultJmsListenerContainerFactory factory =
	 * new DefaultJmsListenerContainerFactory(); //
	 * factory.setConnectionFactory(cachingConnectionFactory); ////
	 * factory.setDestinationResolver(destinationResolver()); //
	 * factory.setSessionTransacted(true); // factory.setConcurrency("3-10"); //
	 * return factory; // }
	 */  
